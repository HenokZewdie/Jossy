...
public class Relationship {
  ...
  **/
  @ApiModelProperty(example = "Javier Perez Cuellar- Individual", value = "The relationship name for a customer")
  ...
  **/
  @ApiModelProperty(example = "SOLE_OWNER", value = "This is a reference data field. Please use /v1/apac/utilities/referenceData/{relationshipType} resource to get valid value of this field with description. You can use the field name as the referenceCode parameter to retrieve the values.")
