...
public class ReadyCreditAccountSummary {
   ...
   * @return productName
  **/
  @ApiModelProperty(example = "Ready Credit", value = "The name of the product")
   ...
   * @return productCode
  **/
  @ApiModelProperty(example = "RC_RC100", value = "A unique code that identifies the product")
  ...
  **/
  @ApiModelProperty(example = "Ready Credit Account", value = "The nickname of the account assigned by the customer")
  ...
  **/
  @ApiModelProperty(example = "15000.25", value = "Available Credit for the ready credit account. It is the amount that is available to be charged to a ready credit account")
