...
public class MutualFundAccount {
   ...
   * @return productName
  **/
  @ApiModelProperty(example = "Mutual Fund Account", value = "The name of the product")
   ...
   * @return productCode
  **/
  @ApiModelProperty(example = "0201_VC890", value = "A unique code that identifies the product")
  ...
  **/
  @ApiModelProperty(example = "5000.25", value = "Total of net asset value of mutual funds")
