...
public class Transaction {
  ...
  **/
  @ApiModelProperty(example = "2015-06-21", value = "Transaction date in YYYY-MM-DD format value conforming to ISO 8601. This needs to be formatted in front-end for country/locale specific display purposes. This is the field used for default sorting,")
  ...
  **/
  @ApiModelProperty(example = "INTEREST PAYMENT", value = "Transaction description from the merchant, POS or bank. If there are foreign currency transactions on checking /saving account(s) then description includes exchange rate, city and country.")
  ...
  **/
  @ApiModelProperty(example = "BIMI51807310002051", value = "Reference Id to uniquely identify the transaction")
  ...
  **/
  @ApiModelProperty(example = "89000125", value = "The check serial number. Applicable for checking accounts only")
  ...
  **/
  @ApiModelProperty(example = "50.55", value = "Transaction amount in local currency.")
   ...
   * @return currencyCode
  **/
  @ApiModelProperty(example = "EUR", value = "The currency code of the transaction in ISO 4217 format")
  ...
  **/
  @ApiModelProperty(example = "50.55", value = "The transaction amount in the foreign currency")
  ...
  **/
  @ApiModelProperty(example = "USD", value = "The foreign currency code of the transaction in ISO 4217 format")
  ...
  **/
  @ApiModelProperty(example = "1.55", value = "The exchange rate at the time the foreign transaction was done")
  ...
  **/
  @ApiModelProperty(example = "DEBIT", value = "The type of transaction. This is a reference data field. Please use /v1/apac/utilities/referenceData/{transactionType} resource to get possible values of this field with descriptions. You can use the field name as the referenceCode parameter to retrieve the values")
  ...
  **/
  @ApiModelProperty(example = "1485.8", value = "The amount available to transact immediately")
  ...
  **/
  @ApiModelProperty(example = "2016-12-02", value = "Transaction posting date in YYYY-MM-DD format value conforming to ISO 8601. This needs to be formatted in front-end for country/locale specific display purposes. This is the field used for default sorting")
  ...
  **/
  @ApiModelProperty(example = "260", value = "The transaction code")
   ...
   * @return merchantName
  **/
  @ApiModelProperty(example = "Alcott EU, Via Alberto Lionello, Roma", value = "The merchant name with which this transaction was made with")
  ...
  **/
  @ApiModelProperty(example = "ELIGIBLE", value = "The EPP allowed indicator. This is applicable for credit cards transactions only. This is a reference data field. Please use /v1/apac/utilities/referenceData/{eligibleForEqualPaymentPlan} resource to get possible value of This field with description. You can use the field name as the referenceCode parameter to retrieve the values")
