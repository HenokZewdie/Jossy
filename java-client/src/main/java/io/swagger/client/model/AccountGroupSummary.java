...
public class AccountGroupSummary {
   ...
   * @return accountGroup
  **/
  @ApiModelProperty(example = "SAVINGS", required = true, value = "Account group is a classification of accounts according to their common characteristics. This is a reference data field. Please use /v1/apac/utilities/referenceData/{accountGroup} resource to get valid value of this field with description. You can use the field name as the referenceCode parameter to retrieve the values.")
   ...
   * @return accounts
  **/
  @ApiModelProperty(required = true, value = "Summarized list of each account type under a specific product group, held by customer")
  ...
  **/
  @ApiModelProperty(value = "Summarized list of every insurance policy held by the customer.")
