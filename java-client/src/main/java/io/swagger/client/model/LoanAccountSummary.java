...
public class LoanAccountSummary {
   ...
   * @return productName
  **/
  @ApiModelProperty(example = "Personal Loan Account", value = "The name of the product")
   ...
   * @return productCode
  **/
  @ApiModelProperty(example = "PL_001", value = "A unique code that identifies the product")
  ...
  **/
  @ApiModelProperty(example = "Personal Loan Account", value = "The nickname of the account assigned by the customer")
  ...
  **/
  @ApiModelProperty(example = "10000.25", value = "The amount borrowed")
  ...
  **/
  @ApiModelProperty(example = "15000.25", value = "The amount of money owed.")
