...
public class CreditCardAccount {
   ...
   * @return productName
  **/
  @ApiModelProperty(example = "Credit Card Account", value = "The name of the product")
   ...
   * @return productCode
  **/
  @ApiModelProperty(example = "0500_VC901", value = "A unique code that identifies the product")
  ...
  **/
  @ApiModelProperty(example = "XXXXXXXXXXXX2391", required = true, value = "A masked account number that can be displayed to the customer")
  ...
  **/
   ...
   * @return creditUsed
  **/
  @ApiModelProperty(example = "3750.25", value = "The part of the credit limit already used")
  ...
  **/
  @ApiModelProperty(example = "3750.25", value = "The available credit")
  ...
  **/
  @ApiModelProperty(example = "15000.25", value = "Cash advance amount available. This will be same as the cash limit if there is no cash advance done. Otherwise, this will be the amount from the cashLimit minus the cash advance amount already used")
  ...
  **/
  @ApiModelProperty(example = "2015-06-12", value = "The date of the next payment/payment due date in ISO 8601 date format YYYY-MM-DD")
  ...
  **/
  @ApiModelProperty(example = "1500.25", value = "Available reward points on the credit card")
