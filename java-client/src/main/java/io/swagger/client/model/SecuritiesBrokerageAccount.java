...
public class SecuritiesBrokerageAccount {
   ...
   * @return productName
  **/
  @ApiModelProperty(example = "Securities Brokerage Account", value = "The name of the product")
   ...
   * @return productCode
  **/
  @ApiModelProperty(example = "0101_VC801", value = "A unique code that identifies the product")
  ...
  **/
  @ApiModelProperty(example = "5000.25", value = "The total market worth of securities")
  ...
  **/
  @ApiModelProperty(example = "4500.25", value = "Total transaction amount in local currency")
  ...
  **/
  @ApiModelProperty(example = "500.25", value = "Total unrealized gains amount, profitable position that has yet to be cashed in")
