...
public class InvestmentTransaction {
   ...
   * @return orderDate
  **/
  @ApiModelProperty(example = "2016-09-05", value = "Order date in YYYY-MM-DD format value conforming to ISO 8601. This needs to be formatted in front-end for country/locale specific display purposes. This is the field used for default sorting")
  ...
  **/
  @ApiModelProperty(example = "100234568743532", value = "Reference Id to uniquely identify the investment transaction")
   ...
   * @return orderType
  **/
  @ApiModelProperty(example = "BUY", value = "This is a reference data field. Please use /v1/apac/utilities/referenceData/{orderType} resource to get possible value of this field with description. You can use the field name as the referenceCode parameter to retrieve the values.")
   ...
   * @return code
  **/
  @ApiModelProperty(example = "BCF0001BB", value = "Order code to uniquely identify the transaction,")
   ...
   * @return name
  **/
  @ApiModelProperty(example = "BIMI51807310002051", value = "Unique name  for fund/stock")
  ...
  **/
  @ApiModelProperty(example = "12500.12", value = "Transaction amount in local currency.")
   ...
   * @return price
  **/
  @ApiModelProperty(example = "21.32", value = "Order price of  trade")
   ...
   * @return orderStatus
  **/
  @ApiModelProperty(example = "SETTLED", value = "This is a reference data field. Please use /v1/apac/utilities/referenceData/{orderStatus} resource to get possible value of This field with description. You can use the field name as the referenceCode parameter to retrieve the values.")
   ...
   * @return grossAmount
  **/
  @ApiModelProperty(example = "5000.25", value = "The total amount of the transaction")
  ...
  **/
  @ApiModelProperty(example = "1100.0", value = "Total number of units ordered")
  ...
  **/
  @ApiModelProperty(example = "1100.0", value = "Number of units received")
  ...
  **/
  @ApiModelProperty(example = "1255.0", value = "Number of units not received")
  ...
  **/
  @ApiModelProperty(example = "NYSE", value = "Trading market code for securities")
