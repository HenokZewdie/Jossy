...
public class GroupBalance {
  ...
  **/
  @ApiModelProperty(example = "AUD", value = "The currency code for local country in ISO 4217 format")
  ...
  **/
  @ApiModelProperty(example = "8900.12", value = "Summarized balances in local currency")
  ...
  **/
  @ApiModelProperty(example = "SGD", value = "The foreign currency code for foreign country in ISO 4217 format")
  ...
  **/
  @ApiModelProperty(example = "8880.25", value = "Summarized balances in foreign currency")
