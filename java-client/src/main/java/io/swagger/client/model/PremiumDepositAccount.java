...
public class PremiumDepositAccount {
   ...
   * @return productName
  **/
  @ApiModelProperty(example = "Premium Deposit Account", value = "The name of the product")
   ...
   * @return productCode
  **/
  @ApiModelProperty(example = "0061_VC401", value = "A unique code that identifies the product")
  ...
  **/
  @ApiModelProperty(example = "100000.25", value = "The investment amount in base currency")
  ...
  **/
  @ApiModelProperty(example = "AUD", value = "The base currency code in ISO 4217 format")
  ...
  **/
  @ApiModelProperty(example = "145000.25", value = "The investment amount in alternate currency")
   ...
   * @return openingDate
  **/
  @ApiModelProperty(example = "2016-12-02", value = "Premium deposit open date in ISO 8601 date format YYYY-MM-DD")
  ...
  **/
  @ApiModelProperty(example = "EUR", value = "The alternate currency code in ISO 4217 format")
  ...
  **/
  @ApiModelProperty(example = "C036", value = "The account number to deposit returns of base currency, upon maturity")
  ...
  **/
  @ApiModelProperty(example = "C978", value = "The account number to deposit returns of alternate currency, upon maturity")
  ...
  **/
  @ApiModelProperty(example = "1000.25", value = "The accrued interest amount in base currency")
  ...
  **/
  @ApiModelProperty(example = "1050.25", value = "The accrued interest amount in alternate currency")
  ...
  **/
  @ApiModelProperty(example = "90867.25", value = "The investment amount and accrued interest in alternate currency")
  ...
  **/
  @ApiModelProperty(example = "145000.25", value = "A part or all of the interest the customer earns on the Premium Account represents the premium that the bank pays the customer for the currency option")
   ...
   * @return maturityDate
  **/
  @ApiModelProperty(example = "2018-12-31", value = "The date when the premium deposit will mature, in ISO8601 date format YYYY-MM-DD")
   ...
   * @return strikePrice
  **/
  @ApiModelProperty(example = "145.25", value = "The Pre-agreed exchange rate")
  ...
  **/
  @ApiModelProperty(example = "4.01", value = "The customer interest rate applicable for the premium deposit")
  ...
  **/
  @ApiModelProperty(example = "5.01", value = "The accrued interest rate applicable for the premium deposit")
  ...
  **/
  @ApiModelProperty(example = "4.01", value = "The benchmark interest rate applicable for the premium deposit")
   ...
   * @return dealStatus
  **/
  @ApiModelProperty(example = "ACTIVE", value = "The deal status. This is a reference data field. Please use /v1/apac/utilities/referenceData/{dealStatus} resource to get valid value of this field with description. You can use the field name as the referenceCode parameter to retrieve the values.")
   ...
   * @return expiryDate
  **/
  @ApiModelProperty(example = "2018-12-31", value = "The date when the premium deposit deal will expire, in ISO8601 date format YYYY-MM-DD")
   ...
   * @return tenorTerm
  **/
  @ApiModelProperty(example = "12", value = "The tenor term for deposit")
   ...
   * @return tenorPeriod
  **/
  @ApiModelProperty(example = "MONTHS", value = "This is a reference data field. Please use /v1/apac/utilities/referenceData/{tenorPeriod} resource to get valid value of this field with description. You can use the field name as the referenceCode parameter to retrieve the values.")
