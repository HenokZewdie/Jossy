...
public class CallDepositAccount {
   ...
   * @return productName
  **/
  @ApiModelProperty(example = "Call Deposit Account", value = "The name of the product")
   ...
   * @return productCode
  **/
  @ApiModelProperty(example = "0051_VC201", value = "A unique code that identifies the product")
  ...
  **/
  @ApiModelProperty(example = "15000.25", value = "The current balance including any pending or in progress deposits and withdrawals")
   ...
   * @return interestRate
  **/
  @ApiModelProperty(example = "0.0125", value = "The rate of interest applicable for the call deposit account")
   ...
   * @return openingDate
  **/
  @ApiModelProperty(example = "2007-12-01", value = "Call deposit account opening date in ISO 8601 date format YYYY-MM-DD")
  ...
  **/
  @ApiModelProperty(example = "15000.25", value = "Maturity amount on the call deposit account.")
  ...
  **/
  @ApiModelProperty(example = "500.25", value = "Last interest payment amount on the call deposit account.")
  ...
  **/
  @ApiModelProperty(example = "2016-12-02", value = "Last interest payment date in ISO 8601 date format YYYY-MM-DD")
