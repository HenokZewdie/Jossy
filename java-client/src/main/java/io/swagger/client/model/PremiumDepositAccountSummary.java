...
public class PremiumDepositAccountSummary {
  ...
  **/
   ...
   * @return productCode
  **/
  @ApiModelProperty(example = "PD_301", value = "A unique code that identifies the product")
  ...
  **/
  @ApiModelProperty(example = "PD Account", value = "The nickname of the account assigned by the customer")
