...
public class CreditCardAccountSummary {
  ...
  **/
  @ApiModelProperty(example = "XXXXXXXXXXXX0364", value = "A masked account number that can be displayed to the customer")
  ...
  **/
  @ApiModelProperty(example = "10000.25", value = "The amount of money owed on the credit account. It is the outstanding balance in applicable level (either card, account or relationship levels)")
  ...
  **/
  @ApiModelProperty(example = "15000.25", value = "Available Credit limit on the credit card")
   ...
   * @return creditLimit
  **/
  @ApiModelProperty(example = "25000.25", value = "The maximum amount of credit that extend to a customer")
  ...
  **/
  @ApiModelProperty(example = "256.5", value = "Minimum due amount for a payment cycle")
  ...
  **/
  @ApiModelProperty(example = "2016-10-05", value = "The payment due date in ISO 8601 date format YYYY-MM-DD")
  ...
  **/
  @ApiModelProperty(example = "USD", value = "The alternate currency")
  ...
  **/
  @ApiModelProperty(example = "1534.25", value = "The current balance in alternate currency")
  ...
  **/
  @ApiModelProperty(example = "PRIMARY", value = "Indicator to specify whether the card is primary or supplementary. This is a reference data field. Please use /v1/apac/utilities/referenceData/{cardHolderType} resource to get valid value of this field with description.")
