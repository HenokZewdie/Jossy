...
public class LoanAccount {
   ...
   * @return productName
  **/
  @ApiModelProperty(example = "Loan Account", value = "The name of the product")
   ...
   * @return productCode
  **/
  @ApiModelProperty(example = "0800_VC601", value = "A unique code that identifies the product")
  ...
  **/
  @ApiModelProperty(example = "200000.25", value = "The amount borrowed")
  ...
  **/
  @ApiModelProperty(example = "18000.25", value = "The remaining principal amount")
  ...
  **/
  @ApiModelProperty(example = "20000.25", value = "The amount of money owed.")
   ...
   * @return currencyCode
  **/
  @ApiModelProperty(example = "EUR", value = "The currency code in ISO 4217 format")
   ...
   * @return maturityDate
  **/
  @ApiModelProperty(example = "2037-12-31", value = "Loan maturity date in ISO 8601 date format YYYY-MM-DD")
   ...
   * @return openingDate
  **/
  @ApiModelProperty(example = "2007-12-01", value = "Loan account opening date in ISO 8601 date format YYYY-MM-DD")
  ...
  **/
  @ApiModelProperty(example = "2014-01-14", value = "The date of the last payment in ISO 8601 format YYYY-MM-DD")
  ...
  **/
  @ApiModelProperty(example = "8463.25", value = "The amount of the last payment made")
  ...
  **/
  @ApiModelProperty(example = "91504.81", value = "Interest amount paid for the mentioned period")
  ...
  **/
  @ApiModelProperty(example = "9230.67", value = "The next payment amount due")
  ...
  **/
  @ApiModelProperty(example = "2018-06-13", value = "The date of the next payment in ISO 8601 date format YYYY-MM-DD")
  ...
  **/
  @ApiModelProperty(example = "MONTHLY", value = "The payment frequency")
   ...
   * @return interestType
  **/
  @ApiModelProperty(example = "VARIABLE", value = "The interest type. This is a reference data field. Please use /v1/apac/utilities/referenceData/{interestType} resource to get valid value of this field with description. You can use the field name as the referenceCode parameter to retrieve the values.")
   ...
   * @return interestRate
  **/
  @ApiModelProperty(example = "10.08", value = "Loan interest rate.")
  ...
  **/
  @ApiModelProperty(example = "10.1", value = "Loan effective interest rate")
  ...
  **/
  @ApiModelProperty(example = "1200.25", value = "Installment loan payment amount")
  ...
  **/
  @ApiModelProperty(example = "1200.25", value = "Term remaining.")
  ...
  **/
  @ApiModelProperty(example = "20000.25", value = "Past due is a loan payment that has not been made as of its due date")
  ...
  **/
  @ApiModelProperty(example = "200000.25", value = "The amount of principal returned to the bank")
  ...
  **/
  @ApiModelProperty(example = "20000.25", value = "Late charge amount applicable when amount is not paid by the due date")
