...
public class TimeDepositAccountSummary {
   ...
   * @return productName
  **/
  @ApiModelProperty(example = "Time Deposit", value = "The name of the product")
   ...
   * @return productCode
  **/
  @ApiModelProperty(example = "TD_1YRT", value = "A unique code that identifies the product")
  ...
  **/
  @ApiModelProperty(example = "Time Deposit", value = "The nickname of the account assigned by the customer")
  ...
  **/
  @ApiModelProperty(example = "XXXXXX2364", value = "A masked account number that can be displayed to the customer")
  ...
  **/
  @ApiModelProperty(example = "166171.53", value = "The account balance on the time deposit account")
  ...
  **/
  @ApiModelProperty(example = "10000.25", value = "The amount invested")
   ...
   * @return maturityDate
  **/
  @ApiModelProperty(example = "2015-06-30", value = "The date when the time deposit will mature in ISO8601 date format YYYY-MM-DD")
